...
const int CONNECTED_BIT_HTTP = BIT0;
const char *TAG_HTTP = "example";
...
esp_err_t event_handler(void *ctx, system_event_t *event)
{
    ...
    case SYSTEM_EVENT_STA_GOT_IP:
        xEventGroupSetBits(wifi_event_group, CONNECTED_BIT_HTTP);
        break;
    case SYSTEM_EVENT_STA_DISCONNECTED:
        /* This is a workaround as ESP32 WiFi libs don't currently
           auto-reassociate. */
        esp_wifi_connect();
        xEventGroupClearBits(wifi_event_group, CONNECTED_BIT_HTTP);
        break;
    default:
        break;
    }
...
void initialise_wifi(void)
{
    ...
    ESP_LOGI(TAG_HTTP, "Setting WiFi configuration SSID %s...", wifi_config.sta.ssid);
